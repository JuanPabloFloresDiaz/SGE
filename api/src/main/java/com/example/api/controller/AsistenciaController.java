...
public class AsistenciaController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de asistencias obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Page.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Asistencia encontrada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AsistenciaResponse.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de asistencias obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = List.class)))
        })
        ...
        @Operation(summary = "Obtener estadísticas de asistencia", description = "Obtiene estadísticas de asistencia de un estudiante usando HashMap (Tabla Hash)")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Estadísticas obtenidas exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Map.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de asistencias eliminadas obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = List.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "Asistencia registrada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AsistenciaResponse.class))),
                        @ApiResponse(responseCode = "400", description = "Datos inválidos")
        })
        public ResponseEntity<AsistenciaResponse> createAsistencia(
                        @Valid @RequestBody CreateAsistenciaRequest request,
                        HttpServletRequest httpRequest) {
                AsistenciaResponse createdAsistencia = asistenciaService.createAsistencia(request, httpRequest);
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Asistencia actualizada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AsistenciaResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Asistencia no encontrada"),
                        @ApiResponse(responseCode = "400", description = "Datos inválidos")
        })
        public ResponseEntity<AsistenciaResponse> updateAsistencia(
                        ...
                        HttpServletRequest httpRequest) {
                return ResponseEntity.ok(asistenciaService.updateAsistencia(id, request, httpRequest));
        }
        ...
        public ResponseEntity<Void> deleteAsistencia(
                        @Parameter(description = "ID de la asistencia") @PathVariable String id,
                        HttpServletRequest httpRequest) {
                asistenciaService.deleteAsistencia(id, httpRequest);
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Asistencia restaurada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AsistenciaResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Asistencia no encontrada")
        })
