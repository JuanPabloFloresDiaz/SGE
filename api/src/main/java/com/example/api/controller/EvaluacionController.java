...
public class EvaluacionController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de evaluaciones obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Page.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Evaluación encontrada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = EvaluacionResponse.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de evaluaciones obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = List.class)))
        })
        ...
        @GetMapping("/proximas")
        @Operation(summary = "Listar próximas evaluaciones", description = "Obtiene todas las evaluaciones futuras (fecha >= hoy) que están publicadas")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de próximas evaluaciones obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = List.class)))
        })
        ...
        @Operation(summary = "Listar evaluaciones ordenadas por fecha", description = "Obtiene todas las evaluaciones ordenadas por fecha usando el algoritmo Bubble Sort (propósito educativo)")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de evaluaciones ordenadas obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = List.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de evaluaciones eliminadas obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = List.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "Evaluación creada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = EvaluacionResponse.class))),
        ...
        public ResponseEntity<EvaluacionResponse> createEvaluacion(
                ...
                EvaluacionResponse created = evaluacionService.createEvaluacion(request, httpRequest);
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Evaluación actualizada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = EvaluacionResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Evaluación no encontrada"),
                        @ApiResponse(responseCode = "400", description = "Datos de entrada inválidos")
        })
        public ResponseEntity<EvaluacionResponse> updateEvaluacion(
                        ...
                        HttpServletRequest httpRequest) {
                return ResponseEntity.ok(evaluacionService.updateEvaluacion(id, request, httpRequest));
        }
        ...
        public ResponseEntity<Void> deleteEvaluacion(
                        @Parameter(description = "ID de la evaluación") @PathVariable String id,
                        HttpServletRequest httpRequest) {
                evaluacionService.deleteEvaluacion(id, httpRequest);
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Evaluación restaurada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = EvaluacionResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Evaluación no encontrada")
        })
