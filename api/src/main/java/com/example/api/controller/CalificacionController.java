...
public class CalificacionController {
    ...
    @Operation(summary = "Listar calificaciones", description = "Obtiene todas las calificaciones activas con paginación")
    @ApiResponses({
    ...
    @Operation(summary = "Obtener calificación por ID", description = "Obtiene una calificación específica por su ID")
    @ApiResponses({
    ...
    @Operation(summary = "Obtener calificaciones por estudiante", description = "Lista todas las calificaciones de un estudiante específico")
    @ApiResponses({
    ...
    @Operation(summary = "Obtener calificaciones por evaluación", description = "Lista todas las calificaciones de una evaluación específica")
    @ApiResponses({
    ...
    @Operation(summary = "Obtener historial del estudiante (Lista Ligada)", description = "Obtiene el historial de calificaciones usando estructura de Lista Ligada. "
            +
    ...
    @Operation(summary = "Calcular promedio del estudiante", description = "Calcula el promedio de calificaciones de un estudiante")
    @ApiResponses({
    ...
    @Operation(summary = "Obtener ranking general (Árbol BST)", description = "Obtiene el ranking de estudiantes usando Árbol BST (TreeMap). "
            +
    ...
    @Operation(summary = "Obtener ranking por curso (Árbol BST)", description = "Obtiene el ranking de estudiantes de un curso usando Árbol BST. "
            +
    ...
    @Operation(summary = "Buscar por rango de notas (Búsqueda Binaria)", description = "Busca calificaciones en un rango de notas usando Búsqueda Binaria. "
            +
    ...
    @Operation(summary = "Ordenar por nota (Algoritmo de Burbuja)", description = "Ordena calificaciones usando el algoritmo de Burbuja (Bubble Sort). "
            +
    ...
    @Operation(summary = "Obtener estadísticas (Tabla Hash)", description = "Obtiene estadísticas de distribución de notas usando HashMap (Tabla Hash). "
            +
    ...
    @Operation(summary = "Listar calificaciones eliminadas", description = "Obtiene todas las calificaciones que han sido eliminadas lógicamente")
    @ApiResponses({
    ...
    @Operation(summary = "Crear calificación", description = "Crea una nueva calificación para un estudiante en una evaluación. "
            +
            "Valida que tanto la evaluación como el estudiante existan.")
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Calificación creada exitosamente", content = @Content(schema = @Schema(implementation = CalificacionResponse.class))),
    ...
    public ResponseEntity<CalificacionResponse> createCalificacion(
        ...
        CalificacionResponse created = calificacionService.createCalificacion(request, httpRequest);
        return ResponseEntity.status(HttpStatus.CREATED).body(created);
    }

    @Operation(summary = "Actualizar calificación", description = "Actualiza una calificación existente. Permite actualización parcial.")
    @ApiResponses({
    ...
    public ResponseEntity<CalificacionResponse> updateCalificacion(
            ...
            HttpServletRequest httpRequest) {
        return ResponseEntity.ok(calificacionService.updateCalificacion(id, request, httpRequest));
    }

    @Operation(summary = "Eliminar calificación (soft delete)", description = "Realiza un borrado lógico de la calificación")
    @ApiResponses({
    ...
    public ResponseEntity<Void> deleteCalificacion(
            @Parameter(description = "ID de la calificación") @PathVariable String id,
            HttpServletRequest httpRequest) {
        calificacionService.deleteCalificacion(id, httpRequest);
        return ResponseEntity.noContent().build();
    }

    @Operation(summary = "Eliminar calificación permanentemente", description = "Elimina físicamente una calificación de la base de datos. Esta acción es irreversible.")
    @ApiResponses({
    ...
    @Operation(summary = "Restaurar calificación", description = "Restaura una calificación que ha sido eliminada lógicamente")
    @ApiResponses({
