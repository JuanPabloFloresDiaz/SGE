...
public class ActividadController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de actividades obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Page.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Actividad encontrada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ActividadResponse.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de actividades obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = List.class)))
        })
        ...
        @GetMapping("/abiertas")
        @Operation(summary = "Listar actividades abiertas", description = "Obtiene todas las actividades que están actualmente abiertas (fecha actual entre apertura y cierre)")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de actividades abiertas obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = List.class)))
        })
        ...
        @GetMapping("/proximas")
        @Operation(summary = "Listar próximas actividades", description = "Obtiene todas las actividades que aún no han abierto (fecha de apertura futura)")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de próximas actividades obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = List.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de actividades eliminadas obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = List.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "Actividad creada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ActividadResponse.class))),
        ...
        public ResponseEntity<ActividadResponse> createActividad(
                ...
                ActividadResponse created = actividadService.createActividad(request, httpRequest);
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Actividad actualizada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ActividadResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Actividad no encontrada")
        })
        public ResponseEntity<ActividadResponse> updateActividad(
                        ...
                        HttpServletRequest httpRequest) {
                return ResponseEntity.ok(actividadService.updateActividad(id, request, httpRequest));
        }
        ...
        public ResponseEntity<Void> deleteActividad(
                        @Parameter(description = "ID de la actividad") @PathVariable String id,
                        HttpServletRequest httpRequest) {
                actividadService.deleteActividad(id, httpRequest);
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Actividad restaurada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ActividadResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Actividad no encontrada")
        })
