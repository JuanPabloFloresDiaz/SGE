...
public class ClaseController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de clases obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Page.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Clase encontrada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ClaseResponse.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de clases obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = List.class)))
        })
        ...
        public ResponseEntity<List<ClaseResponse>> getClasesByFecha(
                        @Parameter(description = "Fecha de las clases (formato: yyyy-MM-dd)") @PathVariable @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate fecha) {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Lista de clases eliminadas obtenida exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = List.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "Clase creada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ClaseResponse.class))),
                        @ApiResponse(responseCode = "400", description = "Datos inválidos")
        })
        public ResponseEntity<ClaseResponse> createClase(
                        @Valid @RequestBody CreateClaseRequest request,
                        HttpServletRequest httpRequest) {
                ClaseResponse createdClase = claseService.createClase(request, httpRequest);
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Clase actualizada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ClaseResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Clase no encontrada"),
                        @ApiResponse(responseCode = "400", description = "Datos inválidos")
        })
        public ResponseEntity<ClaseResponse> updateClase(
                        ...
                        HttpServletRequest httpRequest) {
                return ResponseEntity.ok(claseService.updateClase(id, request, httpRequest));
        }
        ...
        public ResponseEntity<Void> deleteClase(
                        @Parameter(description = "ID de la clase") @PathVariable String id,
                        HttpServletRequest httpRequest) {
                claseService.deleteClase(id, httpRequest);
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Clase restaurada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ClaseResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Clase no encontrada")
        })
